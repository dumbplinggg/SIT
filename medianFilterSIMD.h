...
public:
    ...
    static void median_filter_3x3_simd(const uint8_t* input, uint8_t* output, size_t width, size_t height, size_t stride);
};
...
void MedianFilterSIMD::median_filter_3x3_simd(const uint8_t* input, uint8_t* output, size_t width, size_t height, size_t stride) {
